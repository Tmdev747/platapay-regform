...
export function BusinessExperience() {
  ...
  const addPlataPay = watch("addPlataPay")
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <RadioGroup
            defaultValue="yes"
            onValueChange={(value) => register("firstTimeBusiness").onChange({ target: { value } })}
          >
        ...
        <div className="space-y-2">
          ...
          <RadioGroup
            defaultValue="no"
            onValueChange={(value) => register("existingBusiness").onChange({ target: { value } })}
          >
            <div className="flex items-center space-x-2">
        ...
        {existingBusiness === "yes" && (
          <div className="space-y-2">
            ...
            <RadioGroup
              defaultValue="no"
              onValueChange={(value) => register("addPlataPay").onChange({ target: { value } })}
            >
              <div className="flex items-center space-x-2">
      ...
      {showBusinessDetails && (
        <div className="space-y-6 border p-4 rounded-md bg-gray-50">
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => register("business.type").onChange({ target: { value } })}>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => register("additionalBusiness.type").onChange({ target: { value } })}>
              <SelectTrigger>
                <SelectValue placeholder="Select type" />
              </SelectTrigger>
              <SelectContent>
