    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="border-2 hover:border-[#4A2A82] transition-all">
            ...
            <CardFooter>
              <div className="flex items-center space-x-2 w-full">
                <RadioGroupItem value="basic" id="plan-basic" {...register("plan")} />
          ...
          <Card className="border-2 hover:border-[#4A2A82] transition-all">
            ...
            <CardFooter>
              <div className="flex items-center space-x-2 w-full">
                <RadioGroupItem value="plus" id="plan-plus" {...register("plan")} />
          ...
          <Card className="border-2 hover:border-[#4A2A82] transition-all">
            ...
            <CardFooter>
              <div className="flex items-center space-x-2 w-full">
                <RadioGroupItem value="premium" id="plan-premium" {...register("plan")} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="border-2 hover:border-[#4A2A82] transition-all">
            ...
            <CardFooter>
              <div className="flex items-center space-x-2 w-full">
                <RadioGroupItem value="enterprise" id="enterprise-basic" {...register("enterprisePackage")} />
          ...
          <Card className="border-2 hover:border-[#4A2A82] transition-all">
            ...
            <CardFooter>
              <div className="flex items-center space-x-2 w-full">
                <RadioGroupItem value="enterprise-deluxe" id="enterprise-deluxe" {...register("enterprisePackage")} />
